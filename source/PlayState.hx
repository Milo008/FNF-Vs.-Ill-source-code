	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				...
				case 'thorns':
					curStage = 'schoolEvil';
			    case 'really-good-friends' | 'your-end':
				    curStage = 'illstage';
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'illstage': //it's for the mod now stfu
				var illstage:BGSprite = new BGSprite('illstage', -600, -200, 0.9, 0.9);
				add(illstage);

				case 'illstage2':
				var illstage2:BGSprite = new BGSprite('illstage2', -600, -200, 0.9, 0.9);
				add(illstage2);
